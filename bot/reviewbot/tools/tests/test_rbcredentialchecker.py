"""Unit tests for reviewbot.tools.rbcredentialchecker."""

from __future__ import unicode_literals

import six

from reviewbot.tools.rbcredentialchecker import CredentialCheckerTool
...
class CredentialCheckerToolTests(BaseToolTestCase):
    """Unit tests for CredentialCheckerTool."""

    tool_class = CredentialCheckerTool

    def test_get_can_handle_file(self):
        """Testing CredentialCheckerTool.get_can_handle_file"""
    ...
    def test_execute_with_asana_access_token(self):
        """Testing CredentialCheckerTool.execute with Asana Access Token"""
    ...
    def test_execute_with_aws_access_key_a3t(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (A3T...)
        """
    ...
    def test_execute_with_aws_access_key_abia(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ABIA...)
        """
    ...
    def test_execute_with_aws_access_key_acca(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ACCA...)
        """
    ...
    def test_execute_with_aws_access_key_agpa(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (AGPA...)
        """
    ...
    def test_execute_with_aws_access_key_aida(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (AIDA...)
        """
    ...
    def test_execute_with_aws_access_key_aipa(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (AIPA...)
        """
    ...
    def test_execute_with_aws_access_key_akia(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (AKIA...)
        """
    ...
    def test_execute_with_aws_access_key_anpa(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ANPA...)
        """
    ...
    def test_execute_with_aws_access_key_anva(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ANVA...)
        """
    ...
    def test_execute_with_aws_access_key_apka(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (APKA...)
        """
    ...
    def test_execute_with_aws_access_key_aroa(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (AROA...)
        """
    ...
    def test_execute_with_aws_access_key_asca(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ASCA...)
        """
    ...
    def test_execute_with_aws_access_key_asia(self):
        """Testing CredentialCheckerTool.execute with AWS Access Key (ASIA...)
        """
    ...
    def test_execute_with_dropbox_short_lived_access_token(self):
        """Testing CredentialCheckerTool.execute with Dropbox Short-Lived
        Access Token
        """
        self._run_token_test(
    ...
    def test_execute_with_facebook_access_token(self):
        """Testing CredentialCheckerTool.execute with Facebook Access Token"""
    ...
    def test_execute_with_github_legacy_oauth_token(self):
        """Testing CredentialCheckerTool.execute with legacy GitHub OAuth
        Token
        """
    ...
    def test_execute_with_github_oauth_token_gho(self):
        """Testing CredentialCheckerTool.execute with GitHub token (gho...)"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_github_oauth_token_ghp(self):
        """Testing CredentialCheckerTool.execute with GitHub token (ghp...)"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_github_oauth_token_ghr(self):
        """Testing CredentialCheckerTool.execute with GitHub token (ghr...)"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_github_oauth_token_ghs(self):
        """Testing CredentialCheckerTool.execute with GitHub token (ghs...)"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_github_oauth_token_ghu(self):
        """Testing CredentialCheckerTool.execute with GitHub token (ghu...)"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_google_gcp_api_key(self):
        """Testing CredentialCheckerTool.execute with Google GCP API Key"""
    ...
    def test_execute_with_google_gcp_client_id(self):
        """Testing CredentialCheckerTool.execute with Google GCP Client ID"""
        self._run_token_test(
    ...
    def test_execute_with_google_gcp_service_account_config(self):
        """Testing CredentialCheckerTool.execute with Google GCP Service
    ...
    def test_execute_with_heroku_api_key(self):
        """Testing CredentialCheckerTool.execute with Heroku API Key"""
        self._run_token_test(
            'HEROKU_API_KEY=1234abcd-12ab-34cd-56ef-123456abcdef')

    @integration_test()
    def test_execute_with_json_web_token(self):
        """Testing CredentialCheckerTool.execute with JSON Web Token"""
        self._run_token_test(
    ...
    def test_execute_with_mailchimp_api_key(self):
        """Testing CredentialCheckerTool.execute with Mailchimp API key"""
    ...
    def test_execute_with_mailgun_api_key(self):
        """Testing CredentialCheckerTool.execute with Mailgun API key"""
    ...
    def test_execute_with_npm_access_token(self):
        """Testing CredentialCheckerTool.execute with NPM Access Token"""
    ...
    def test_execute_with_pgp_private_key(self):
        """Testing CredentialCheckerTool.execute with PGP Private Key"""
        self._run_token_test('----BEGIN PGP PRIVATE KEY BLOCK----')

    @integration_test()
    def test_execute_with_pypi_api_token(self):
        """Testing CredentialCheckerTool.execute with PyAPI API Token"""
        self._run_token_test(
    ...
    def test_execute_with_slack_token_xoxb(self):
        """Testing CredentialCheckerTool.execute with Slack Token (xoxb...)
        """
        self._run_token_test(
    ...
    def test_execute_with_slack_token_xoxo(self):
        """Testing CredentialCheckerTool.execute with Slack Token (xoxo...)
        """
        self._run_token_test(
    ...
    def test_execute_with_slack_token_xoxp(self):
        """Testing CredentialCheckerTool.execute with Slack Token (xoxp...)
        """
        self._run_token_test(
    ...
    def test_execute_with_slack_token_xoxr(self):
        """Testing CredentialCheckerTool.execute with Slack Token (xoxr...)
        """
        self._run_token_test(
    ...
    def test_execute_with_slack_webhook_url(self):
        """Testing CredentialCheckerTool.execute with Slack WebHook URL"""
        self._run_token_test(
    ...
    def test_execute_with_stripe_live_api_key(self):
        """Testing CredentialCheckerTool.execute with Stripe API key
        (sk_live_...)
        """
    ...
    def test_execute_with_twilio_account_sid(self):
        """Testing CredentialCheckerTool.execute with Twilio Account SID"""
    ...
    def test_execute_with_twilio_api_key(self):
        """Testing CredentialCheckerTool.execute with Twilio API Key"""
    ...
    def test_execute_with_twitter_oauth(self):
        """Testing CredentialCheckerTool.execute with Twitter OAuth Token"""
        # Lower bounds of length.
        self._run_token_test(
    ...
    def test_execute_with_success(self):
        """Testing CredentialCheckerTool.execute with successful result"""
